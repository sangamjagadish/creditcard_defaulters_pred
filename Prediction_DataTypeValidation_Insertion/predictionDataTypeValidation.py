...
class DBOperation:
        ...
        for file in onlyfiles:
            ...
            try:
                ...
                query = f"""CREATE TABLE IF NOT EXISTS Good_Raw_Data(id int  PRIMARY KEY, "{cols[0]}" Int,"{cols[1]}" Int,"{cols[2]}" Int,"{cols[3]}" Int,
                                        ...
                                        "{cols[15]}" Int,"{cols[16]}" Int,"{cols[17]}" Int,"{cols[18]}" Int,"{cols[19]}" Int,"{cols[20]}" Int,"{cols[21]}" Int,"{cols[22]}" Int);"""
                session.execute(query)
            ...
            try:
                ...
                for i in range(len(values)):
                    try:
                        ...
                        "{cols[22]}") VALUES({i},{values[i][0]},{values[i][1]},{values[i][2]},{values[i][3]},{values[i][4]},{values[i][5]},{values[i][6]},{values[i][7]},{values[i][8]},
    ...
    def selectingDatafromtableintocsv(self, keyspace):
        ...
        try:
            ...
            sortfile = sortfile[
                ['Age','Bill_Amt1','Bill_Amt2','Bill_Amt3','Bill_Amt4','Bill_Amt5','Bill_Amt6','Education','Limit_Bal','Marriage','Pay_0','Pay_2','Pay_3','Pay_4','Pay_5','Pay_6','Pay_Amt1','Pay_Amt2','Pay_Amt3','Pay_Amt4','Pay_Amt5','Pay_Amt6','Sex']]
