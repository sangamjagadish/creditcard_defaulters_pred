...
class File_Operation:
    ...
    def save_model(self,model, filename):
        ...
        self.logger_object.log(self.file_object, "Entered the save_model method of the File_Oeration class")
    ...
    def load_model(self,filename):
        ...
        """
        Description: Loads the model file from directory
        Outcome: The model file gets loaded
        On Failure: Raise Exception
        """
